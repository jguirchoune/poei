 ...
 */
function lemonde_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  $form['theme_ui'] = array(
    '#type' => 'details',
    '#title' => t('UI Elements'),
  );

  $form['theme_ui']['lemonde_status_in_reveal'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => theme_get_setting('lemonde_status_in_reveal'),
  );
  ...
  $form['theme_javascript']['lemonde_use_respondjs'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => theme_get_setting('lemonde_use_respondjs'),
  );
  ...
  $form['region_settings']['lemonde_meta_header_grid'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => theme_get_setting('lemonde_meta_header_grid'),
  );
  ...
  $form['topbar']['lemonde_top_bar_enable'] = array(
    '#type' => 'select',
    '#title' => t('Enable'),
    ...
    '#default_value' => theme_get_setting('lemonde_top_bar_enable'),
  );

  $form['topbar']['container']['lemonde_top_bar_grid'] = array(
    '#type' => 'checkbox',
    '#title' => t('Contain to grid'),
    '#description' => t('Check this for your top bar to be set to your grid width.'),
    '#default_value' => theme_get_setting('lemonde_top_bar_grid'),
  );

  $form['topbar']['container']['lemonde_top_bar_sticky'] = array(
    '#type' => 'checkbox',
    '#title' => t('Sticky'),
    ...
    '#default_value' => theme_get_setting('lemonde_top_bar_sticky'),
  );

  $form['topbar']['container']['lemonde_top_bar_is_hover'] = array(
    '#type' => 'checkbox',
    '#title' => t('Hover to expand menu'),
    '#description' => t('Set this to false to require the user to click to expand the dropdown menu.'),
    '#default_value' => theme_get_setting('lemonde_top_bar_is_hover'),
  );
  ...
  $form['topbar']['container']['menu']['lemonde_top_bar_menu_text'] = array(
    '#type' => 'textfield',
    '#title' => t('Menu text'),
    '#description' => t('Specify text to go beside the mobile menu icon or leave blank for none.'),
    '#default_value' => theme_get_setting('lemonde_top_bar_menu_text'),
  );

  $form['topbar']['container']['menu']['lemonde_top_bar_custom_back_text'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => theme_get_setting('lemonde_top_bar_custom_back_text'),
  );

  $form['topbar']['container']['menu']['lemonde_top_bar_back_text'] = array(
    '#type' => 'textfield',
    '#title' => t('Custom back text'),
    '#description' => t('Define what you want your custom back text to be.'),
    '#default_value' => theme_get_setting('lemonde_top_bar_back_text'),
  );
  ...
  $form['topbar']['container']['search']['lemonde_top_bar_search'] = array(
    '#type' => 'checkbox',
    '#title' => t('Enable Search Menu'),
    '#description' => t('Displays the Search menu in the Top Bar.'),
    '#default_value' => theme_get_setting('lemonde_top_bar_search'),
  );
  ...
  if (\Drupal::moduleHandler()->moduleExists('language')) {
    ...
    $form['topbar']['container']['languageswitcher']['lemonde_top_bar_languageswitcher'] = array(
      '#type' => 'checkbox',
      '#title' => t('Enable Language switcher'),
      '#description' => t('Displays the Language switcher in the Top Bar.'),
      '#default_value' => theme_get_setting('lemonde_top_bar_languageswitcher'),
    );
  }
  ...
  $form['page_elements']['lemonde_page_site_name'] = array(
    '#type' => 'checkbox',
    '#title' => t('Show site name'),
    '#description' => t('Determines if the hard-coded site name should be displayed.'),
    '#default_value' => theme_get_setting('lemonde_page_site_name'),
  );

  $form['page_elements']['lemonde_page_site_logo'] = array(
    '#type' => 'checkbox',
    '#title' => t('Show site logo'),
    '#description' => t('Determines if the hard-coded site logo should be displayed.'),
    '#default_value' => theme_get_setting('lemonde_page_site_logo'),
  );

  $form['page_elements']['lemonde_page_account_info'] = array(
    '#type' => 'checkbox',
    '#title' => t('Show Login/Signup information'),
    '#description' => t('Determines if the hard-coded login block should be displayed.'),
    '#default_value' => theme_get_setting('lemonde_page_account_info'),
  );
  ...
  $form['styles_scripts']['lemonde_disable_base_css'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => theme_get_setting('lemonde_disable_base_css'),
  );

  $form['styles_scripts']['lemonde_disable_base_js'] = array(
    '#type' => 'checkbox',
    ...
    '#default_value' => theme_get_setting('lemonde_disable_base_js'),
  );
}
